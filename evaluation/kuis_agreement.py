...
# Load data
df = pd.read_json('../assets/results/kuis_mistral_english.json')
...
for user_id in user_ids:
    ...
    df_user_id = df_user_id.apply(lambda x: [y for y in x if y['subject'] == 'kuis'])
    for key in keys:
        print("KEY", key)
...
df_to_excel.to_excel('../assets/agreement/ratna_kuis_agreement.xlsx', index=False)
