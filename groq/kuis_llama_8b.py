...
PATH_ENGLISH = "../assets/results/kuis_llama_8b_english_2.json" if IS_FULL_DATA else "../assets/sampling/results/kuis_llama_8b_english.json"
PATH_ID = "../assets/results/kuis_llama_8b_id_2.json" if IS_FULL_DATA else "../assets/sampling/results/kuis_llama_8b_id.json"
PATH_ANSWER = "../assets/kuis.json" if IS_FULL_DATA else "../assets/sampling/kuis_answers.json"

print(IS_FULL_DATA, PATH_ENGLISH, PATH_ID, PATH_ANSWER)
