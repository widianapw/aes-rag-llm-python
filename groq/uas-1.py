...
def get_current_max_no(key):
    try:
        with open("../assets/results/uas_llama_id_1.json", "r") as file:
            data = json.load(file)
...
questions = []
with open("../assets/llama_uas_with_answers_english.json", "r") as f:
...
for question in questions:
    ...
    for answer in answers:
        ...
        append_to_json("../assets/results/uas_llama_id_1.json", result_id)
        append_to_json("../assets/results/uas_llama_english_1.json", result_english)