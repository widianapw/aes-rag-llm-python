...
def get_current_max_no(key):
    try:
        with open("../assets/results/uas_llama_id_8.json", "r") as file:
            data = json.load(file)
...
with open("../assets/uas_with_answers_english.json", "r") as f:
    ...
    questions = filter(lambda x: x['key'] == 'response-8', questions)
...
for question in questions:
    ...
    for answer in answers:
        ...
        append_to_json("../assets/results/uas_llama_id_8.json", result_id)
        append_to_json("../assets/results/uas_llama_english_8.json", result_english)