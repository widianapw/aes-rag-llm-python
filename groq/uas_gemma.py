...
def get_current_max_no(key):
    try:
        with open("../assets/results/uas_gemma_id.json", "r") as file:
            data = json.load(file)
...
for question in questions:
    ...
    for answer in answers:
        ...
        append_to_json("../assets/results/uas_gemma_id.json", result_id)
        append_to_json("../assets/results/uas_gemma_english.json", result_english)