...
def get_current_max_no(key):
    try:
        with open("../assets/results/uas_llama_8b_id_2.json", "r") as file:
            data = json.load(file)
...
for question in questions:
    ...
    for answer in answers:
        ...
        append_to_json("../assets/results/uas_llama_8b_id_2.json", result_id)
        append_to_json("../assets/results/uas_llama_8b_english_2.json", result_english)