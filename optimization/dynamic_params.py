...
METHOD = "m1"
API_KEY = "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"
...
if IS_FULL_DATA:
    ...
    PATH_ENGLISH = f"../assets/sampling/results/docs/{METHOD}{SUBJECT}_{MODEL_NAME}_english.json"
    PATH_ID = f"../assets/sampling/results/docs/{METHOD}{SUBJECT}_{MODEL_NAME}_id.json"
