...
def get_current_max_no(key):
    try:
        with open("../assets/results/kuis_gemma_id.json", "r") as file:
            data = json.load(file)
...
for question in questions:
    ...
    for answer in answers:
        ...
        append_to_json("../assets/results/kuis_gemma_id.json", result_id)
        append_to_json("../assets/results/kuis_gemma_english.json", result_english)