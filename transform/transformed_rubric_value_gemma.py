...
df_kuis_llama = pd.read_json('../assets/results/kuis_gemma_english.json')
df_uas_llama = pd.read_json('../assets/results/uas_gemma_english.json')
...
with open("../assets/results/kuis_gemma_english_transformed.json", "w") as outfile:
    outfile.write(json_object_kuis)

json_object_uas = json.dumps(transformed_uas_llama, indent=4)
with open("../assets/results/uas_gemma_english_transformed.json", "w") as outfile:
